...
//Програма для порівняння продуктивності однопотокового та багатопотокового виконання
public class Processor {
    ...
    public static void main(String[] args) {
        ...
        // Однопотокове виконання
        {
            ...
            System.out.println(result + " Однопотокове виконання: " + (d2 - d1) + " мс");
        }
        ...
        // Багатопотокове виконання
        {
            ...
            Long result = bt.startTask();
            long d2 = System.currentTimeMillis();
            System.out.println(result + " Багатопотокове виконання: " + (d2 - d1) + " мс");
        }
       
        System.out.println("Finish");
    }
   
    // Основна обчислювальна задача
    public Long process() {
        Long summa = 0L;
...
// Клас для виконання задачі в одному потоці
...
//Клас для виконання задачі в декількох потоках
...
//Клас, що реалізує Callable інтерфейс для багатопотокового виконання
